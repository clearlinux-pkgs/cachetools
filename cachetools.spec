...
Source0  : https://files.pythonhosted.org/packages/49/c9/5791269161be47eacca42ffa0a87e0a4a1007b6dfbec0400ae36d43c08f7/cachetools-4.2.0.tar.gz
...
%prep
%setup -q -n cachetools-4.2.0
cd %{_builddir}/cachetools-4.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607703784
...
cp %{_builddir}/cachetools-4.2.0/LICENSE %{buildroot}/usr/share/package-licenses/cachetools/032e9c18ee13324b4608033116bba3af670fe595
