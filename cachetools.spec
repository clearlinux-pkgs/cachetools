...
%prep
%setup -q -n cachetools-4.2.1
cd %{_builddir}/cachetools-4.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611588714
...
cp %{_builddir}/cachetools-4.2.1/LICENSE %{buildroot}/usr/share/package-licenses/cachetools/032e9c18ee13324b4608033116bba3af670fe595
